...
MAIN CORE TOMCAT AS_TESTS RTS JACOCO XTS QA_JTA QA_JTS_JACORB QA_JTS_JDKORB QA_JTS_OPENJDKORB PERF LRA_THORNTAIL LRA_WILDFLY !NO_WIN DB_TESTS mysql db2 postgres oracle
