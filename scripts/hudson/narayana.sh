...
function init_test_options {
    [ $NARAYANA_VERSION ] || NARAYANA_VERSION="4.17.46.Final-SNAPSHOT"
...
function build_as {
  ...
  # building with -Dtest + -DfailIfNoTests to get downloaded test dependencies to local maven repo on the build time
  (cd .. && ./build.sh -f jboss-as/pom.xml -B clean install -Dtest=NonExistentTest -DfailIfNoTests=false -Dts.smoke=false $IPV6_OPTS -Drelease=true -Dversion.org.jboss.jboss-transaction-spi=7.1.0.SP2 -Dversion.org.jboss.jbossts.jbossjts=4.17.46.Final-SNAPSHOT -Dversion.org.jboss.jbossts.jbossjts-integration=4.17.46.Final-SNAPSHOT -Dversion.org.jboss.jbossts.jbossxts=4.17.46.Final-SNAPSHOT -Dversion.org.jboss.jbossts=4.17.46.Final-SNAPSHOT $AS_XARGS)
...
function xts_as_tests {
  ...
  (cd ../ && ./build.sh -f ./jboss-as/testsuite/integration/xts/pom.xml -B -Pxts.integration.tests.profile -Dversion.org.jboss.jboss-transaction-spi=7.1.0.SP2 -Dversion.org.jboss.jbossts.jbossjts=4.17.46.Final-SNAPSHOT -Dversion.org.jboss.jbossts.jbossjts-integration=4.17.46.Final-SNAPSHOT -Dversion.org.jboss.jbossts.jbossxts=4.17.46.Final-SNAPSHOT -Dversion.org.jboss.jbossts=4.17.46.Final-SNAPSHOT "$@" $IPV6_OPTS test $AS_XARGS)
