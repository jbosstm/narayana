...
function build_narayana {
  ...
  ./build.sh -Dfindbugs.skip=false -Dfindbugs.failOnError=false -Prelease,community$OBJECT_STORE_PROFILE -Didlj-enabled=true "$@" $NARAYANA_ARGS $IPV6_OPTS clean install
