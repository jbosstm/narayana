...
[source,java]
----
include::{sourcedir}/extras/indirect_and_implicit.java[]
----
====
...
[source,java]
----
include::{sourcedir}/extras/indirect_and_implicit_close.java[]
----
====
...
[source,java]
----
include::{sourcedir}/extras/direct_and_explicit.java[]
----
====
...
[source,java]
----
include::{sourcedir}/extras/direct_and_explicit_client_requests.java[]
----
====
...
[source,java]
----
include::{sourcedir}/extras/direct_and_explicit_commit.java[]
----
====
...
[source,Java]
----
include::{sourcedir}/extras/transactional_object.java[]
----
====
