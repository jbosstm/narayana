...
[source,xml]
----
include::{sourcedir}/extras/RecoveryManager-properties.xml[]
----

.orportability-properties.xml
[source,xml]
----
include::{sourcedir}/extras/orportability-properties.xml[]
----
...
[source,java]
----
include::{sourcedir}/extras/XAConnectionRecovery.java[]
----
...
[source,xml]
----
include::{sourcedir}/extras/ExpiryScanner-properties.xml[]
----
