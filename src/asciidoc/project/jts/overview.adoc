...
link:#img-commit-protocol[This Two-Phase Commit image] illustrates the main aspects of the commit protocol.
...
[#img-commit-protocol]
.Two-Phase Commit
image::../images/jts-img-2phase.png[Two-Phase Commit]
