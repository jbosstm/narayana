...
.OTS architecture
image::../images/jts-ots_architecture.png[]
...
[source,C]
----
include::{sourcedir}/extras/terminator_coordinator_control.java[]
----
====
...
[source,C]
----
include::{sourcedir}/extras/Current.java[]
----
====
...
[source,java]
----
include::{sourcedir}/extras/simple_transactional_client_2.java[]
----
====
...
[source,java]
----
include::{sourcedir}/extras/simple_transactional_client_3.java[]
----
====
...
image::../images/jts-top_level_transaction_current.png[]

.Creation of a transaction using `Current`
image::../images/jts-subtransaction_current.png[]
...
[source,java]
----
include::{sourcedir}/extras/completing_top_level_transaction.java[]
----
====
...
image::../images/jts-resource_nested_transactions.png[]
...
[source,C]
----
include::{sourcedir}/extras/SubtransactionAwareResource.java[]
----
====
...
image::../images/jts-register_subtran_aware.png[]

.Method `register_resource`
image::../images/jts-register_resource.png[]
...
[source,C]
----
include::{sourcedir}/extras/synchronization.java[]
----
====
...
image::../images/jts-sub-transaction-commit.png[]
...
image::../images/jts-sub-transaction-rollback.png[]
...
[[_top_level_commit]]
.Top-level commit
image::../images/jts-top-level-commit.png[]
...
image::../images/jts-resource-and-recoverycoordinator.png[]
...
[source,java]
----
include::{sourcedir}/extras/CheckedAction-implementation.java[]
----
====
