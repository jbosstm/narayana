...
image::../images/core-txcore_class_hierarchy.png[align="center"]
...
Refer to <<_statemanager_signature>> for the simplified signature of the class.

.Simplified signature of the `StateManager` class
====
[source,java]
----
include::extras/StateManager-signature.java[]
----
====
...
[source,java]
----
include::extras/example-save_state.java[]
----
====
...
image::../images/core-txoj-lifecycle.png[align="center"]
...
[source,java]
----
include::extras/Example_extends_LockManager.java[]
----
====
...
[source,java]
----
include::extras/activation_termination_commitment.java[]
----
...
[source,java]
----
include::extras/simple_concurrency_control.java[]
----
====
