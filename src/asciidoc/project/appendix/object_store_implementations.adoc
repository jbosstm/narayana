...
[source,java]
----
include::{sourcedir}/extras/appendix_StateStatus.java[]
----
====
...
[source,text]
----
include::{sourcedir}/extras/default_layout.txt[]
----
====
...
Therefore, the default object store implementation for {product}, [path]_ShadowNoFileLockStore_, relies upon user-level locking.
...
[source,java]
----
include::{sourcedir}/extras/jdbcaccess.java[]
----
====
