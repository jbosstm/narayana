...
[source,java]
----
include::{sourcedir}/extras/using_suspend_method.java[]
----
...
[source,java]
----
include::{sourcedir}/extras/Transaction_Equality.java[]
----
...
[source,java]
----
include::{sourcedir}/extras/TransactionSynchronizationRegistry_standalone.java[]
----
