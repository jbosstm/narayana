...
image::../images/failure-recovery-fig1-crashrecoveryarchitecture.png[align="center"]
...
[source,java]
----
include::{sourcedir}/extras/recoveryScanInterface.java[]
----
...
[source,java]
----
include::{sourcedir}/extras/recoveryModuleInterface.java[]
----
...
image::../images/failure-recovery-fig2-resourceinitiatedrecovery.png[align="center"]
...
[source,java]
----
include::{sourcedir}/extras/XAResourceRecoveryInterface.java[]
----
...
[source,java]
----
include::{sourcedir}/extras/XAResourceRecoveryHelper.java[]
----
...
[source,xml]
----
include::./extras/xmlDatasource.xml[]
----
====
...
[source,xml]
----
include::./extras/jndiDatasource.xml[]
----
