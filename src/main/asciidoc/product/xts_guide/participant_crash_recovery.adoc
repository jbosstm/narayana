...
[source,java]
----
include::{sourcedir}/extras/example-PersistableATParticipant.java[]
----
...
[source,java]
----
include::{sourcedir}/extras/example-register-for-recovery.java[]
----
...
[source,java]
----
include::{sourcedir}/extras/example-XTSATRecoveryModule.java[]
----
...
[source,java]
----
include::{sourcedir}/extras/example-PersistableBAParticipant.java[]
----
...
[source,java]
----
include::{sourcedir}/extras/example-XTSBARecoveryManager.java[]
----
...
[source,java]
----
include::{sourcedir}/extras/example-XTSBARecoveryModule.java[]
----
...
[source,java]
----
include::{sourcedir}/extras/example-ConfirmCompletedParticipant.java[]
----
