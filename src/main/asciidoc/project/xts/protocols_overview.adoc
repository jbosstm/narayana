...
[source,xml]
----
include::extras/example-wsc-interfaces.xml[]
----
...
[source,xml]
----
include::extras/example-wsc-registration.xml[]
----
...
The actual APIs used to initiate and complete a transaction and to register a participant and drive it through the commit or abort process are described in <<sec_xts_api>>.
...
Underpinning all of this are three fundamental assumptions, detailed in <<wsba_assumptions>> .
