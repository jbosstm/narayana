...
[source,java]
----
include::{sourcedir}/extras/example-idl-interface.java[]
----
====
...
[source,java]
----
include::{sourcedir}/extras/example-DemoResource.java[]
----
====
...
[source,java]
----
include::{sourcedir}/extras/transactional-implementation.java[]
----
====
...
[source,java]
----
include::{sourcedir}/extras/DemoServer.java[]
----
====
...
[source,java]
----
include::{sourcedir}/extras/DemoClient.java[]
----
====
...
.Sequence Diagram
image::../images/jts-sequence-diagram.png[]
