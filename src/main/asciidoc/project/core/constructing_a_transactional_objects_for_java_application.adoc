...
[source,java]
----
include::extras/example_queue_class.java[]
----
====

== Constructors and finalizers

Using an existing persistent object requires the use of a special constructor that takes the Uid of the persistent object, as shown in <<_example_transactionalqueue>> .

.Class `TransactionalQueue`
====
[source,java]
----
include::extras/example-TransactionalQueue.java[]
----
====
...
[source,java]
----
include::extras/example_queue_destructor.java[]
----
...
[source,java]
----
include::extras/example-queue_save_state.java[]
----
====
...
[source,java]
----
include::extras/example-queue_restore_state.java[]
----
====
...
[source,java]
----
include::extras/example-queue_type.java[]
----
====
...
[source,java]
----
include::extras/example-queue_queueSize.java[]
----
====
...
[source,java]
----
include::extras/example-queue_inspectValue.java[]
----
====
...
[source,java]
----
include::extras/example-queue_main.java[]
----
====
