...
[source,java]
----
include::extras/nested_transactions_in_constructors.java[]
----
...
[source,java]
----
include::extras/StateManager_activate_method.java[]
----
...
[source,java]
----
include::extras/StateManager_deactivate_method.java[]
----
...
[source,java]
----
include::extras/StateManager_modified_method.java[]
----
