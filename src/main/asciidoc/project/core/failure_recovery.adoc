...
[source,xml]
----
include::extras/recoveryEnvironmentBean.xml[]
----
====
...
[source,xml]
----
include::extras/recoveryEnvironmentBeanExpiryScanners.xml[]
----
====
...
[source,text]
----
include::extras/atomicaction.txt[]
----
====
...
[source,java]
----
include::extras/TestRecoveryModule.java[]
----
====
...
[source,java]
----
include::extras/SimpleRecord.java[]
----
====
...
[source,java]
----
include::extras/SimpleRecoveryModule.java[]
----
====
...
[source,xml]
----
include::extras/recoveryEnvironmentBeanRecoveryExtensions.xml[]
----
====
