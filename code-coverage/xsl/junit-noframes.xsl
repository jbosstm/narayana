...
<xsl:param name="narayana.home.url"/>
<xsl:param name="copyright.years"/>

<!--
      Narayana test report stylesheet.
-->
<xsl:template match="testsuites">
    <html>
        <head>
            ...
            <title>Narayana - JUnit Test Results</title>
    ...
    <style type="text/css">
      ...
      .Failure {
        ...
        <body>
			...
			<div class="footer">
				<span class="right"><a href="{$narayana.home.url}">Narayana</a>&#160;<xsl:value-of select="$qualified.bundle.version"/></span>
				<a href="../doc/license.html">Copyright</a> &#169; <xsl:value-of select="$copyright.years"/> TODO check whether we can use this stylesheet (it is ASF copyright) Mountainminds GmbH &amp; Co. KG and Contributors
			</div>
        </body>
    </html>
</xsl:template>
...
<xsl:template name="pageHeader">
	<div class="breadcrumb">
		<a href="../index.html" class="el_report">Narayana</a> &gt;
