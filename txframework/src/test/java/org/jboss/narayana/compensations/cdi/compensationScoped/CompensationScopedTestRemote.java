...
package org.jboss.narayana.compensations.cdi.compensationScoped;
...
public class CompensationScopedTestRemote extends CompensationScopedTest {
    ...
    public static JavaArchive createTestArchive() {
        ...
        JavaArchive archive = ShrinkWrap.create(JavaArchive.class, "test.jar")
                .addPackage(CompensationScopedTestRemote.class.getPackage())
                .addPackage(DummyData.class.getPackage())
