...
public class ORBType
{
    ...
    private final static String[]           ORB_NAME = { orbix2000, hporb, visibroker, javaidl, ibmorb };
    private final static int[]              ORB_ENUM = { ORBIX2000, HPORB, VISIBROKER, JAVAIDL, IBMORB };
}
