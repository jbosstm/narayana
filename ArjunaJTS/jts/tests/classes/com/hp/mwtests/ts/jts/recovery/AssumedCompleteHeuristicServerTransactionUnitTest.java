...
public final class AssumedCompleteHeuristicServerTransactionUnitTest {
    ...
    public void testType() {
        Assert.assertEquals(AssumedCompleteHeuristicServerTransaction.typeName(), transaction.type());
    }

    @Test
    public void testToString() {
        Assert.assertEquals("AssumedCompleteHeuristicServerTransaction <" + uid + ">", transaction.toString());
    }
