 ...
 * ibmorb orb.  The RCs are created locally but also will be
...
public class JavaIdlRCManager implements RcvCoManager
{
    ...
    static
    {
       ...
       */
        ...
        String ibmorb_noDaemon = System.getProperty("com.arjuna.ats.internal.jts.orbspecific.ibmorb.recoverycoordinators.noDaemon");

        _runWithoutDaemon = (idl_noDaemon != null && idl_noDaemon.equals("YES"))
		    || (ibmorb_noDaemon != null && ibmorb_noDaemon.equals("YES"));
    }
