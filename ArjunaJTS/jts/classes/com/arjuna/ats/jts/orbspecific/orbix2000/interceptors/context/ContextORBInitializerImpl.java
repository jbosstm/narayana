...
public class ContextORBInitializerImpl extends LocalObject implements ORBInitializer
{
     ...
     * @message com.arjuna.ats.internal.jts.orbspecific.orbix2000.interceptors.context.codeccreate Cannot create a codec of the required encoding.
     * @message com.arjuna.ats.internal.jts.orbspecific.orbix2000.interceptors.context.sie A server-side request interceptor already exists with that name.
     */
