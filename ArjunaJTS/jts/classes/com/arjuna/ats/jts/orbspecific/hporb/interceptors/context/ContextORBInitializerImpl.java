...
public class ContextORBInitializerImpl extends LocalObject implements ORBInitializer
{
	...
	if (jtsLogger.logger.isDebugEnabled())
	{
	    jtsLogger.logger.debug(DebugLevel.FUNCTIONS, VisibilityLevel.VIS_PUBLIC,
					       (com.arjuna.ats.jts.logging.FacilityCode.FAC_OTS | com.arjuna.ats.jts.logging.FacilityCode.FAC_INTERCEPTOR), "ContextORBInitializerImpl.pre_init ()");
	}
    ...
    /**
     * @message com.arjuna.ats.internal.jts.orbspecific.hporb.interceptors.context.codecerror {0} - a failure occured when getting {1} codec - unknown encoding.
     * @message com.arjuna.ats.internal.jts.orbspecific.hporb.interceptors.context.duplicatename {0} - duplicate interceptor name for {1} when registering
     * @message com.arjuna.ats.internal.jts.orbspecific.hporb.interceptors.context.codeccreate Cannot create a codec of the required encoding.
     * @message com.arjuna.ats.internal.jts.orbspecific.hporb.interceptors.context.sie A server-side request interceptor already exists with that name.
     */
