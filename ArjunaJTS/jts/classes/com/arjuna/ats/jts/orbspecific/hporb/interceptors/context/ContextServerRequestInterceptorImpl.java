 ...
 *
 * @message com.arjuna.ats.internal.jts.orbspecific.hporb.interceptors.context.srie {0} caught an unexpected exception: {1}
 */
...
public void receive_request_service_contexts (ServerRequestInfo request_info) throws SystemException
	...
	try
	{
		...
		{
		    org.omg.CORBA.Any receivedData = _codec.decode_value(serviceContext.context_data, ORBManager.getORB().orb().get_primitive_tc(TCKind.tk_string));
...
public void send_reply (ServerRequestInfo request_info) throws SystemException
	...
	catch (SystemException ex)
	{
	    ...
	    {
		jtsLogger.loggerI18N.warn("com.arjuna.ats.internal.jts.orbspecific.hporb.interceptors.context.srie",
