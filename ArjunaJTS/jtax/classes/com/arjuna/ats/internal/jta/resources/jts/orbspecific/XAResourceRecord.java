                    ...
                    if (notAProblem(e1, true)) {
                        ...
                        switch (e1.errorCode) {
                            ...
                            case XAException.XA_HEURHAZ:
                                ...
                                throw new org.omg.CosTransactions.HeuristicHazard();
                            case XAException.XA_HEURCOM:
                                // what about forget? OTS doesn't support this code here.
                            ...
                            case XAException.XAER_NOTA:
                                if (_phaseTwoStarted) {
                                    // committed previously on participant
                                    break;
                                }
            ...
            if (_theXAResource != null) {
                ...
                try {
                    ...
                    switch (e1.errorCode) {
                        ...
                        case XAException.XA_RETRY:
                            /*
                             * not allowed to be thrown here by XA specification!
                             * presumed abort (or we could be really paranoid and throw a heuristic)
                             */
                            this._rolledBack = true;
                            throw new TRANSACTION_ROLLEDBACK();
                        ...
                        case XAException.XAER_RMFAIL:
                            /*
                             * This was modified as part of JBTM-XYZ - although RMFAIL is not clear
                             * there is a rollback/commit we are flagging this to the user
                             */
                            throw new org.omg.CosTransactions.HeuristicHazard();
                        default:
                            // will cause log to be rewritten
