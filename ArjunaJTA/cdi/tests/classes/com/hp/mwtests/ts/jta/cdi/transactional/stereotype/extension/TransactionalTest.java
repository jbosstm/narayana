...
public class TransactionalTest {
    ...
    public static WebArchive createTestArchive() {
        return ShrinkWrap.create(WebArchive.class, "JBTM-3503-test.war")
                .addClasses(TransactionalBean.class, NoTransactional.class)
                .addAsWebInfResource(EmptyAsset.INSTANCE, "beans.xml");
    }

    @Test(expected = TestException.class)
    public void neverTransactionalAtBean() throws Exception {
        TransactionalBean.process();
    }
}