...
then
  ...
  mvn clean deploy -Prelease -Dmaven.javadoc.skip=true -DskipTests -pl :narayana-jts-idlj,:jbossxts,:narayana-jts-integration,:byteman_support,:jbosstxbridge,:compensations -am
fi