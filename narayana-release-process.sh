...
then
  ...
  tools/maven/bin/mvn clean deploy -Dmaven.repo.local=${PWD}/localm2repo -Prelease,all -Dmaven.javadoc.skip=true -DskipTests -pl :jbossjts-jacorb,:jbossxts,:jbossjts-integration,:byteman_support,:jbosstxbridge -am
  rm -rf $PWD/localrepo
