 ...
 */
public class CompensationScopedConfirmationHandler implements ConfirmationHandler, Serializable {

    private static final Logger LOGGER = Logger.getLogger(CompensationScopedConfirmationHandler.class);
    ...
    public void confirm() {
        ...
        ResultCollector.getInstance().confirm(data.getData());
    }
