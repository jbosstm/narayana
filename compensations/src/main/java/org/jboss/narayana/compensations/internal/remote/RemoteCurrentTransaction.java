 ...
 */
public class RemoteCurrentTransaction implements CurrentTransaction {

    private final TxContext delegate;

    public RemoteCurrentTransaction(TxContext delegate) {
    ...
    public Class<?> getDelegateClass() {
        return TxContext.class;
    }

    @Override
    public TxContext getDelegate() {
        return delegate;
    }
