...
If you are looking for an issue to work on and haven't had much previous experience with Narayana then you could work on one that has the label "good-first-issue" or look for issues whose "Estimated Difficulty" field is `Low`. For this year's Hacktoberfest we have labelled suitable issues using the label "hacktoberfest" and have created a zulip stream for hacktoberfest discussions.
