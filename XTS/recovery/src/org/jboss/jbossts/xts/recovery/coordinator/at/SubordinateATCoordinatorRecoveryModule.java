...
public class SubordinateATCoordinatorRecoveryModule implements RecoveryModule
{
        ...
        if (XTSLogger.arjLogger.isDebugEnabled())
        {
            XTSLogger.arjLogger.debug
                    ( DebugLevel.CONSTRUCTORS,
                            ...
                            "SubordinateATCoordinatorRecoveryModule created - default" );
        }
    ...
    public void periodicWorkSecondPass()
    {
        ...
        {
            XTSLogger.arjLogger.debug(DebugLevel.CONSTRUCTORS, VisibilityLevel.VIS_PUBLIC,
                    FacilityCode.FAC_CRASH_RECOVERY, "SubordinateATCoordinatorRecoveryModule: Second pass " );
        }
        ...
        if (XTSLogger.arjLogger.isDebugEnabled())
        {
            XTSLogger.arjLogger.debug
                    ( DebugLevel.CONSTRUCTORS,
                            VisibilityLevel.VIS_PUBLIC,
                            FacilityCode.FAC_CRASH_RECOVERY,
                            "SubordinateATCoordinatorRecoveryModule created " + type );
        }
