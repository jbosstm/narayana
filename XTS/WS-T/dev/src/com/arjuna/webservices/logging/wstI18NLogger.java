...
public interface wstI18NLogger {
	...
	@Message(id = 43016, value = "Unknown error: {0}", format = MESSAGE_FORMAT)
	@LogMessage(level = WARN)
	...
	@Message(id = 43061, value = "Unknown error: {0}", format = MESSAGE_FORMAT)
	@LogMessage(level = WARN)
	...
	@Message(id = 43063, value = "Unknown error: {0}", format = MESSAGE_FORMAT)
	@LogMessage(level = WARN)
	...
	@Message(id = 43067, value = "Unknown error: {0}", format = MESSAGE_FORMAT)
	@LogMessage(level = WARN)
	...
	@Message(id = 43106, value = "Unknown error: {0}", format = MESSAGE_FORMAT)
	@LogMessage(level = WARN)
	...
	@Message(id = 43109, value = "Unknown error: {0}", format = MESSAGE_FORMAT)
	@LogMessage(level = WARN)
	...
	@Message(id = 43173, value = "Unknown error: {0}", format = MESSAGE_FORMAT)
	@LogMessage(level = WARN)
	...
	@Message(id = 43175, value = "Unknown error: {0}", format = MESSAGE_FORMAT)
	@LogMessage(level = WARN)
	...
	@Message(id = 43179, value = "Unknown error: {0}", format = MESSAGE_FORMAT)
	@LogMessage(level = WARN)
	...
	@LogMessage(level = WARN)
	public void warn_recovery_participant_at_ATParticipantRecoveryRecord_restoreParticipant_1(String arg0);
	...
	@LogMessage(level = WARN)
	public void warn_recovery_participant_ba_BAParticipantRecoveryRecord_restoreParticipant_1(String arg0);
