 ...
 * UK.  
 *
 * $Id: JDBCActionStoreSetup.java 2342 2006-03-30 13:06:17Z  $
 */
...
public synchronized Object createVoid ()
    {
	if (_theStore == null)
	    _theStore = JDBCActionStore.create();
...
public synchronized Object createResources (Object[] param)
    {
	if (_theStore == null)
	    _theStore = JDBCActionStore.create(param);
