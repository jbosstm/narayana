...
public class ClusterMemberId {
    ...
    public ClusterMemberId(String nodeId) {
        this(nodeId, "0");
    }

    public ClusterMemberId(String nodeId, String failoverGroupId) {
        this(nodeId, failoverGroupId, null);
    }

    public ClusterMemberId(String nodeId, String failoverGroupId, String description) {
