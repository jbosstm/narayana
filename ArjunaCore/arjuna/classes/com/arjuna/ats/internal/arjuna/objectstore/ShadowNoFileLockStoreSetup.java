 ...
 * UK.  
 *
 * $Id: ShadowNoFileLockStoreSetup.java 2342 2006-03-30 13:06:17Z  $
 */
...
public synchronized Object createVoid ()
    {
	return ShadowNoFileLockStore.create();
    }
    
public synchronized Object createResources (Object[] param)
    {
	return ShadowNoFileLockStore.create(param);
    }
...
public synchronized Object createObjectName (ObjectName objectName)
    {
	return ShadowNoFileLockStore.create(objectName);
    }
