 ...
 */
package com.arjuna.ats.internal.arjuna.tools.osb.proxy;
...
import com.arjuna.ats.internal.arjuna.tools.osb.mbean.ParticipantStoreBeanMBean;
import com.arjuna.ats.internal.arjuna.tools.osb.mbean.RecoveryStoreBeanMBean;
...
public class StoreManagerProxy {
    ...
    public static final String RECOVERY_BEAN_NAME = String.format("jboss.jta:type=%s,name=store1", RecoveryStoreBean.class.getName());
    public static final String PARTICIPANT_BEAN_NAME = String.format("jboss.jta:type=%s,name=store1", ParticipantStoreBean.class.getName());
