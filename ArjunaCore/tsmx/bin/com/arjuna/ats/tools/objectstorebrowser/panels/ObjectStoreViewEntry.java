 ...
 * UK.
 *
 * $Id: ObjectStoreViewEntry.java 2342 2006-03-30 13:06:17Z  $
 */
...
public class ObjectStoreViewEntry extends SubTreeViewEntry
{
	...
	public ObjectStoreViewEntry(String tn, String label, ObjectStoreBrowserNode node)
	{
		super(tn, label, node, OBJECT_VIEW_ICON_FILENAME);
