 ...
 * UK.
 *
 * $Id: ListViewEntry.java 2342 2006-03-30 13:06:17Z  $
 */
...
{
	private final static String LIST_VIEW_ICON_FILENAME = "list-icon.gif";

	private String	_tn;
    private ObjectStoreBrowserNode _node;

	public ListViewEntry(String tn, String label, ObjectStoreBrowserNode node)
	{
		super(tn, label, node, LIST_VIEW_ICON_FILENAME);
