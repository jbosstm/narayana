...
public class TestTPGetRply extends TestCase {
    ...
    public void test_tpgetrply_with_TPNOBLOCK() throws ConnectionException, ConfigurationException {
        ...
        int cd = connection.tpacall(server.getServiceNameTPGetRplyTPNOBLOCK(), sendbuf, 0);
        assertTrue(cd != -1);
        ...
        try {
            ...
            assertTrue(TestTPConversation.strcmp(toTest.getBuffer(), "test_tpgetrply_TPNOBLOCK") == 0);
        }
    }
